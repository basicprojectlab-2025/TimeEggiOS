...
//    var body: some View {
//        Group {
//            if !authService.isAuthenticated && !googleSignInService.isSignedIn {
//                // 인증 화면
//                SignUpView()
...
//                
//                Text(googleSignInService.currentUser?.username ?? authService.currentUser?.displayName ?? "사용자")
//                    .font(.title2)
//                    .fontWeight(.semibold)
//                
//                Text(googleSignInService.currentUser?.email ?? authService.currentUser?.email ?? "user@example.com")
//                    .foregroundColor(.secondary)
//                
//                Spacer()
//                
...
//                    // Firebase Auth와 Google Sign-In 모두 로그아웃
//                    authService.signOut()
